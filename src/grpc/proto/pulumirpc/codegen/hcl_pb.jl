...
# original file: pulumi/codegen/hcl.proto (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export DiagnosticSeverity, Pos, Range, Diagnostic
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Pos}, _endpos::Int=0, _group::Bool=false)
    line = zero(Int64)
    column = zero(Int64)
    byte = zero(Int64)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Range}, _endpos::Int=0, _group::Bool=false)
    filename = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Diagnostic}, _endpos::Int=0, _group::Bool=false)
