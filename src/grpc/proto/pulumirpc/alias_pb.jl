...
# original file: pulumi/alias.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"Alias.Spec"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    var"#type" = ""
    stack = ""
    project = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Alias}, _endpos::Int=0, _group::Bool=false)
    alias = nothing
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
