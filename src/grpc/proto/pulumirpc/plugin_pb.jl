...
# original file: pulumi/plugin.proto (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export PluginInfo, PackageParameterization, PluginDependency, PluginAttach
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PluginInfo}, _endpos::Int=0, _group::Bool=false)
    version = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PackageParameterization}, _endpos::Int=0, _group::Bool=false)
    name = ""
    version = ""
    value = UInt8[]
    while !PB.message_done(d, _endpos, _group)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PluginDependency}, _endpos::Int=0, _group::Bool=false)
    name = ""
    kind = ""
    version = ""
    server = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PluginAttach}, _endpos::Int=0, _group::Bool=false)
    address = ""
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PackageDependency}, _endpos::Int=0, _group::Bool=false)
    name = ""
    kind = ""
    version = ""
    server = ""
